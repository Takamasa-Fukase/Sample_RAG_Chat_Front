...
//                 child: newChatButtonForSmallScreen(() {
//                   widget.onTapNewChatButton();
//                 }),
//               ),
//               Expanded(
//                 child: Stack(
...
//                           decoration: borderColor(textString),
//                           child: TextFormField(
...
//                       left: 18,
//                       bottom: 50,
//                       child: chatIcon(_isTextCountValid(textString) &&
...
//           : null,
//       child: Image.asset(
//         // FIXME: 画像にグラデーションをかけることに時間がかかりそうだったため、画像の出しわけで妥協している
//         isEnabled
//             ? 'assets/icons/icon_send_gradient.png'
...
//   }
//
//   /// 新規チャットボタン（画面右端に出現するので左側にフォームとの余白を持たせている）
//   Widget newChatButton(Function() onTapNewChatButton) {
//     return Padding(
...
//             backgroundColor: buttonPaleBlue, // pale blue
//           ),
//           onPressed: () {
//             onTapNewChatButton();
//           },
//           icon: Image.asset(
//             'assets/icons/icon_chat_plus.png',
//             color: Colors.white,
//             width: 15,
//             height: 15,
//           ),
...
//   }
//
//   /// 新規チャットボタン（画面左端に出現するので右側にフォームとの余白を持たせている）
//   Widget newChatButtonForSmallScreen(Function() onTapNewChatButton) {
//     return Padding(
...
//
//   /// チャットアイコン
//   Widget chatIcon(bool isEnabled) {
//     return Image.asset(
//       'assets/icons/icon_chat.png',
//       color: isEnabled ? indigoBlue.withOpacity(0.7) : accentBlue,
//       height: 16,
...
//
//   /// 入力画面の枠線色
//   BoxDecoration borderColor(String string) {
//     if (string.isEmpty) {
//       return BoxDecoration(
//         color: Colors.white,
//         borderRadius: BorderRadius.circular(10),
//         border: Border.all(color: accentBlue, width: 1.4),
//       );
//     } else if (!_isTextCountValid(string)) {
//       return BoxDecoration(
//         color: Colors.white,
//         borderRadius: BorderRadius.circular(10),
...
//
//   // 枠線のグラデーション
//   GradientBoxBorder gradientBorder(List<Color> colors) {
